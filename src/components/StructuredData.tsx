...
export default function StructuredData() {
  useEffect(() => {
    ...
    const organizationSchema = {
      ...
      "logo": "https://islamic-financing-loan-affin.vercel.app/images/logos/affin-bank.png",
    ...
    const websiteSchema = {
      ...
      "potentialAction": {
        "@type": "SearchAction",
        "target": "https://islamic-financing-loan-affin.vercel.app/?q={search_term_string}",
    ...
    const productSchema = {
      ...
      "termsOfService": "https://islamic-financing-loan-affin.vercel.app/terma-syarat"
    }
